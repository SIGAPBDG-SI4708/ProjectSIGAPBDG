    ...
    <div x-show="sedangMemproses" x-transition:enter="transition ease-out duration-200"
        ...
        <div class="flex flex-col items-center gap-5">
            <div class="relative w-20 h-20">
                <div
                    class="absolute inset-0 rounded-2xl bg-gradient-to-br from-indigo-500 to-blue-600 opacity-20 animate-pulse">
                </div>
                <div
                    ...
                    <svg class="w-9 h-9 text-indigo-500 animate-spin" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
    ...
    <nav
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
            <a href="{{ route('beranda') }}" class="flex items-center gap-2.5">
                <div
                    class="w-8 h-8 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-xl flex items-center justify-center shadow-md">
                ...
                <span class="font-bold text-lg tracking-tight text-slate-800 dark:text-white">SIGAP <span
                        class="text-indigo-500">BDG</span></span>
            </a>
            <div class="flex items-center gap-3">
                ...
                <button @click="temaGelap = !temaGelap"
                    ...
                    <span x-show="!temaGelap"><svg class="w-3.5 h-3.5 text-indigo-500" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <main class="max-w-2xl mx-auto px-4 sm:px-6 pt-28 pb-16">
        ...
        @if(session('trackingBerhasil'))
            <div
                ...
                <div class="relative">
                    ...
                    <a href="{{ route('lacak') }}"
                        class="mt-3 inline-flex text-xs text-indigo-500 hover:text-indigo-600 dark:text-indigo-400 transition font-medium items-center gap-1">
        ...
        <form id="formLaporan" action="{{ route('proses.laporan') }}" method="POST" enctype="multipart/form-data"
            ...
            <div
                ...
                <label for="inputFoto"
                    class="upload-area border-2 border-dashed border-slate-200 dark:border-slate-700 hover:border-indigo-400 dark:hover:border-indigo-500 rounded-2xl p-8 flex flex-col items-center justify-center cursor-pointer gap-3 relative group bg-slate-50 dark:bg-slate-800/50 hover:bg-indigo-50/50 dark:hover:bg-indigo-500/5 transition-all">
                    <div id="ikonUpload" class="text-center">
                        <div
                            class="w-14 h-14 bg-slate-100 dark:bg-slate-700 rounded-2xl flex items-center justify-center mx-auto mb-3 group-hover:bg-indigo-100 dark:group-hover:bg-indigo-500/20 transition">
                            <svg class="w-7 h-7 text-slate-400 dark:text-slate-500 group-hover:text-indigo-500 dark:group-hover:text-indigo-400 transition"
            ...
            <button type="button" id="tombolKirim" @click.prevent="munculkanLoadingSwal()"
                class="w-full bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-500 hover:to-blue-500 text-white font-bold py-4 px-6 rounded-2xl shadow-xl shadow-indigo-500/20 flex items-center justify-center gap-2 transition-all duration-200 hover:-translate-y-0.5">
